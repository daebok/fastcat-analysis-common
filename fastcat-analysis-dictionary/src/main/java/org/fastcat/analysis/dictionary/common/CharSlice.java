...
public class CharSlice implements CharSequence, Comparable<CharSequence>, Serializable {
	...
	public CharSlice(char[] array, boolean isIgnoreCase){
		this(array, 0, array.length, isIgnoreCase);
	}
	public CharSlice(char[] array, int start, int length) {
		this(array, start, length, false);
	}
	public CharSlice(char[] array, int start, int length, boolean isIgnoreCase) {
		this.array = array;
		this.start = start;
		this.length = length;
		this.hash = 0;
	...
	public boolean equals(Object anObject) {
		...
		if (anObject instanceof CharSlice) {
			CharSlice anotherArray = (CharSlice) anObject;
			int n = length;
	...
	@Override
	public CharSlice clone() {
		CharSlice c = new CharSlice(array, start, length, isIgnoreCase);
		c.hash = hash;
		return c;
	}
	...
	public void copy(CharSlice another) {
		another.start = start;
	...
	public CharSlice duplicate() {
		char[] buffer = new char[length];
		copy(buffer);
		return new CharSlice(buffer, 0, length, isIgnoreCase);
	}

//	public CharSlice toUpperCase() {
